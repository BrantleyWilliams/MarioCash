...
import dev.zhihexireng.node.api.AccountApi;
import dev.zhihexireng.node.api.ContractApi;
import dev.zhihexireng.node.api.JsonRpcConfig;
import dev.zhihexireng.node.api.TransactionApi;
...
public class NodeContractDemoClient {
    ...
    private static JsonObject getBranchFile(String fileName) throws FileNotFoundException {
        ...
        userDir += "/mariocash-node/src/test/resources/branch/%s";
