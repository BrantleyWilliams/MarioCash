...
public class TransactionMock implements Transaction {
    ...
    public dev.zhihexireng.core.Transaction retTxMock() throws IOException {
        ...
        dev.zhihexireng.core.Transaction tx = new dev.zhihexireng.core.Transaction(from, txObj);
