...
public class ContractClassLoaderTest {
    ...
    public void testContract() throws  IllegalAccessException, InstantiationException,
        ...
        File contractNone =
                new File(".mariocash/contract/9607aea1d4e358a594006c7926a07262b5258c31.class");
    ...
    public void testLoadByHash() {
        ...
        assertEquals("dev.zhihexireng.contract.StemContract", classMeta.getContract().getName());
        ...
        assertEquals("9607aea1d4e358a594006c7926a07262b5258c31",
                classMeta.getContractId().toString());
        assertEquals("dev.zhihexireng.contract.NoneContract", classMeta.getContract().getName());
    }
