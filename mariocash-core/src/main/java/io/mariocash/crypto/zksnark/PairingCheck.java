...
package dev.zhihexireng.crypto.zksnark;

import java.math.BigInteger;
import java.util.ArrayList;
import java.util.List;

import static dev.zhihexireng.crypto.zksnark.Params.B_Fp2;
import static dev.zhihexireng.crypto.zksnark.Params.PAIRING_FINAL_EXPONENT_Z;
import static dev.zhihexireng.crypto.zksnark.Params.TWIST;
